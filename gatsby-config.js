module.exports = {
  siteMetadata: {
    ...
    author : "eka",
    keywords: "Kampus IT Tangerang, Kampus IT Tangerang Selatan, Kampus IT Tangerang Kabupaten, Kampus IT Terdekat, Kampus IT Terdekat dari lokasi saya, Kampus full praktek, kampus bisnis digital, Kampus digital marketing, Kuliah IT Tangerang, Kuliah Jurusan Teknik Informatika, Training MTCNA, training mtcna associate, training mtcna bandung, training mtcna exam, training mtcna jakarta, training mtcna tangerang, training mtcna depok, training mtcna bekasi, training mtcna indonesia, training mtcna tangerang selatan, Training Sertifikasi MTCNA, training sertifikasi mtcna mikrotik, training sertifikasi mtcna associate, training sertifikasi mtcna bandung, training sertifikasi mtcna bekasi, training sertifikasi MTCNA 2024, training sertifikasi MTCNA di indonesia, training sertifikasi MTCNA sertifikat, training sertifikasi MTCNA certificate, training sertifikasi MTCNA surabaya, training sertifikasi MTCNA mtcre, training sertifikasi mikrotik mtcna, training sertifikasi mikrotik 2024, training sertifikasi mikrotik associate, training sertifikasi mikrotik, training sertifikasi mikrotik di makasar, training sertifikasi mikrotik di tangerang, training sertifikasi mikrotik di indonesia, training sertifikasi mikrotik di bekasi, training sertifikasi mikrotik exam, training sertifikasi mikrotik exam, training sertifikasi mikrotik di jakarta, training sertifikasi mikrotik di bandung, training sertifikasi mikrotik bootcamp, training sertifikasi mikrotik bandung, training sertifikasi mikrotik tangerang, training sertifikasi mikrotik surabaya, training mikrotik, training mikrotik jakarta, Jurusan Teknik Informatika, Areta Informatics College, full praktek, Jurusan Teknik Informatika, Pelatihan Jaringan Tangerang, Pelatihan IT 2024, Sertifikasi MikroTik, sertifikasi mikrotik mtcna, sertifikasi mikrotik indonesia, sertifikasi mikrotik certificate, sertifikasi mikrotik certified, sertifikasi mikrotik certification, Sertifikasi IT, sertifikasi MTCNA, sertifikasi jaringan, Sertifikasi Mikrotik 2024, Basic Mikrotik Training, Ahli Jaringan, Pelatihan IT, Pelatihan Jaringan Komputer, Mikrotik Training Seminar, MikroTik Certified Network Associate, Mikrotik Full Praktek, MikroTik Tangerang, MTCNA, MTCRE MTCWE MTCTE",
