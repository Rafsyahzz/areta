...
import { Link } from "gatsby"; // Gatsby's internal link component for SPA routing

// Importing image assets (usually for social icons and logo)
import logo from "../img/social/logo.svg";
import facebook from "../img/social/facebook.svg";
import instagram from "../img/social/instagram.svg";
import TikTok from "../img/social/tik-tok.png"; // TikTok icon (not Twitter, possibly mislabeled?)
...
const Footer = () => {
  ...
  <div
    ...
    <div class="flex justify-center">
      <a href="#55" class="mr-6 text-neutral-600 dark:text-neutral-200">
        <svg
      ...
      <a href="#66" class="mr-6 text-neutral-600 dark:text-neutral-200">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="h-4 w-4"
          fill="currentColor"
      ...
      <a href="#77" class="mr-6 text-neutral-600 dark:text-neutral-200">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="h-5 w-5"
          fill="currentColor"
      ...
      <a href="#88" class="mr-6 text-neutral-600 dark:text-neutral-200">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="h-4 w-4"
          fill="currentColor"
      ...
      <a href="#99" class="mr-6 text-neutral-600 dark:text-neutral-200">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="h-4 w-4"
          fill="currentColor"
      ...
      <a href="#00" class="text-neutral-600 dark:text-neutral-200">
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="h-4 w-4"
          fill="currentColor"
